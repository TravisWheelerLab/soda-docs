...
:Call signature:
 .. rst-class:: trst-call-signature
  ...
  new LineChart(config): LineChart
:Parameters:
...
:Type:
 .. rst-class:: trst-type
  ...
  undefined | :ref:`LineChartRenderParams<LineChartRenderParams>`
...
:Type:
 .. rst-class:: trst-type
  ...
  :ref:`ZoomBehavior<ZoomBehavior>` <:ref:`TrackChart<TrackChart>` <:ref:`LineChartRenderParams<LineChartRenderParams>`>, any> []
...
:Call signature:
 .. rst-class:: trst-call-signature
  ...
  getRenderParams(): LineChartRenderParams
...
This uses the line plot glyph module to render the heatmap and the verticalAxis glyph module to draw a fixed y axis. 
 ...
 .. rst-class:: trst-parameter-dl
   ...
   :Type:
    .. rst-class:: trst-type
     ...
     :ref:`LineChartRenderParams<LineChartRenderParams>`
